...
public class ArtilcesManaging2 implements Initializable {
    ...
    @FXML
    public void refresh(ActionEvent event) {loadContent();}
    ...
    private void loadContent() {
        ...
        for (Articles art : listcard) {
            ...
            fxmlLoader.setLocation(getClass().getResource("/com/example/app/CardViewSpecialiste.fxml"));
            VBox cardBox;
            try {
    ...
    public void gotoaddform(ActionEvent actionEvent) {
        try {
            FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/com/example/app/addArticleForm.fxml"));
    ...
    public void goback(ActionEvent actionEvent) {
            ...
            try {
                FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/com/example/app/Articles-Service.fxml"));
