...
public class CardView {
    ...
    public void gotoform(ActionEvent actionEvent) {
        try {
            FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/com/example/app/updateArticleForm.fxml"));
    ...
    void gotoText(ActionEvent event) {
        try {
            FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/com/example/app/Textshow.fxml"));
            Parent root = fxmlLoader.load();
